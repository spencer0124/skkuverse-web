...
function MapButtons({
  ...
  return (
    <div style={s.mapButtons}>
      <button style={s.mapBtn} onClick={() => openUrl(naverUrl)}>
      ...
      <button style={s.mapBtn} onClick={() => openUrl(kakaoUrl)}>
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      ...
      <button style={s.mapBtn} onClick={() => openUrl(appleUrl)}>
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
  ...
  return (
    <div style={s.root}>
      ...
      <div style={{ ...s.section, ...s.sectionBorder }}>
        ...
        <button
          style={s.contactItem}
          onClick={() => openUrl('tel:01089822852')}
        >
          <div>
        ...
        <button
          ...
          onClick={() => openUrl('tel:0312994224')}
        >
          <div>
